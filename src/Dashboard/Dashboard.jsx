...
import DatabaseDetails from '../Database'
								...
								<div className="card-header">
									<div className="row">
										...
										<div className="col-auto">
											<a href="/invoices" className="btn-right btn btn-sm btn-outline-primary">
												View All 
											</a>
										</div>
									</div>
							...
							<div className="card">
								<div className="card-header">
									<div className="row">
										...
										<div className="col-auto">
											<a href="/estimates" className="btn-right btn btn-sm btn-outline-primary">
												View All 
											</a>
										</div>
									</div>
